...
namespace CoreComponents.Data
{
	...
	public interface IDataExtractor
	{
        ...
        event Gimmie<ExceptionEventArgs<IDataExtractor, Exception>>.GimmieSomethin ReadException;

        event Gimmie<ExceptionEventArgs<IDataExtractor, Exception>>.GimmieSomethin CountException;
