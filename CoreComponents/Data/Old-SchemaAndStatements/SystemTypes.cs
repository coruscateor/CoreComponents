...
namespace CoreComponents.Data.SchemaAndStatements
{
    ...
    //A list of types that are generally common to both the CLI and databases.
    public static class SystemTypes
    {
        ...
        public static bool IsSystemType(Type TheType)
        {

            return TypeList.Contains(TheType);

        }

        public static bool IsSystemType<T>()
        {

            return TypeList.Contains(typeof(T));
