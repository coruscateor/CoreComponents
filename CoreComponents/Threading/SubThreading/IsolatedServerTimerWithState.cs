...
namespace CoreComponents.Threading.SubThreading
{
    ...
    public abstract class IsolatedServerTimerWithState : BaseIsolatedServerTimer, ISubThread
    {
        ...
        public IsolatedServerTimerWithState()
        {
        ...
        public IsolatedServerTimerWithState(double TheInterval, bool Start = true)
